<?php
/**
 * El Apartamento Page - My Suite In Cartagena
...
<link rel="shortcut icon" href="<?php echo I18n::sharedAsset('favicon.png'); ?>"/>
	<title>My Suite In Cartagena - <?php echo __('apartment.title'); ?></title>
	<!-- Meta tag Keywords -->
...
<body>
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								...
								<li><a href="elapto.php" class="active"><?php echo __('nav.apartment'); ?></a></li>
								...
								if ($currentLang !== 'es'): ?>
								<li><a href="elapto.php?lang=es"><img src="<?php echo I18n::sharedAsset('bcolombia.png'); ?>" target="self"></a></li>
								<?php endif; ?>
								<?php if ($currentLang !== 'en'): ?>
								<li><a href="elapto.php?lang=en"><img src="<?php echo I18n::sharedAsset('busa.png'); ?>" target="self"></a></li>
								<?php endif; ?>
								<?php if ($currentLang !== 'it'): ?>
								<li><a href="elapto.php?lang=it"><img src="<?php echo I18n::sharedAsset('bitalia.png'); ?>" target="self"></a></li>
								<?php endif; ?>
							</ul>
						</nav>
					</div>
	...
	<div class="breadcrumb-mobamu">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page"><?php echo __('apartment.breadcrumb'); ?></li>
		</ol>
	</div>
	<!-- //page details -->
	...
	<section class="gallery py-5" id="gallery">
		<div class="container py-md-5">
			<h3 class="tittle text-center font-weight-bold"><?php echo __('apartment.title'); ?></h3>
			<p class="sub-tittle text-center mt-2 mb-sm-5 mb-4 pb-xl-3"><?php echo __('apartment.subtitle'); ?></p>
			<p class="sub-tittle text-center mt-2 mb-sm-5 mb-4 pb-xl-3"><u><strong><?php echo __('apartment.where_rest'); ?></strong></u><br> <strong><?php echo __('apartment.suite1'); ?></strong><br><strong><?php echo __('apartment.suite2'); ?></strong><br><strong><?php echo __('apartment.living_room'); ?></strong></p>

			<p class="sub-tittle text-center mt-2 mb-sm-5 mb-4 pb-xl-3"><u><strong><?php echo __('apartment.what_offers'); ?></strong></u><br><?php echo __('apartment.what_offers_text'); ?></p>

			<p class="sub-tittle text-center mt-2 mb-sm-5 mb-4 pb-xl-3"><u><strong><?php echo __('apartment.and_more'); ?></strong></u><br><?php echo __('apartment.and_more_text'); ?></p>
			...
			<div class="row footer-top">
				...
				<div class="col-lg-3 col-md-6 footer-grid_section_1its mt-lg-0 mt-4">
					...
					<div class="mobamuinfo_social_icons">
						<h3 class="sub-con-fo text-li my-4"><?php echo __('apartment.social_networks'); ?></h3>
	...
	<div >
		<center><p><?php echo __('apartment.copyright'); ?>
		</p></center>
	</div>
	<div class="cpy-right text-center py-3">
<p><?php echo __('apartment.rights'); ?>
		</p>
	</div>
	<!-- //copyright -->
